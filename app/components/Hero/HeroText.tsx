...
export default function HeroText() {
  return (
    <div className="flex flex-col justify-center items-center md:mt-10 md:items-center">
      <span className="pixel-font text-4xl sm:text-5xl uppercase md:text-7xl">
        Ayush
      </span>
      <span className="pixel-font text-5xl sm:text-7xl text-green-400 uppercase leading-none md:text-[7rem]">
        Kumar
      </span>
      <p className="text-base sm:text-lg text-center font-mono px-2 md:block md:text-2xl md:text-gray-300">
